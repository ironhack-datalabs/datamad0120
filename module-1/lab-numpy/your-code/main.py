...
#No pueden unirse porque no tienen la misma forma, aunque tengan el mismo tamaño.

#9. Transpose b so that it has the same structure of a (i.e. become a 2x3x5 array). Assign the transposed array to varialbe "c".
c = b.transpose(1,2,0)
print("Array b tras np.reshape")
print(c)
...
#Al hacer transpose() tienen la misma forma, por eso se pueden sumar. Pero hay un error en el ejercicio 5
print(d)
