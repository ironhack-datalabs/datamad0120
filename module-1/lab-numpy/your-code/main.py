...
# No, they have to have the same shame
#print(a + b)
...
# The values of d are the values of a plus 1, because c is a all 1 matrix
...
# They're equal because we are multiplying the values by 1
