...
a + b
# No, porque son de distintas formas aunque tengan el mismo size.
...
d = a + c
d
# Porque ahora sí son de la misma forma (2,3,5)

#11. Print a and d. Notice the difference and relation of the two array in terms of the values? Explain.

print(a)
print(d)
# La diferencia entre ellas viene dada por la suma de b que se le hace a d. Por eso es n+1 en cada posición
...
# Sí son iguales aunque ahora e me aparece como si fuese un numero float por el punto.
